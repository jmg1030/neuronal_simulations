...
#Function: neuron_population
#Description:
#This is the general framework of an adaptative exponential integrate and fire neuronal population that is randomized connected.
#Each neuron will receive 10 connections from 10 other random neurons.  Noise generator is gaussian centered at 0 with sigma based on
#choice.  Function returns the neuronal population spike times and neuron ID.
